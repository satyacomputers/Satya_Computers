...
export default function DashboardPage() {
  ...
  const statusCards = [
    ...
    { title: 'Busy',                            total: metrics?.statuses?.['Busy']?.total ?? 0,                                     Ramya: metrics?.statuses?.['Busy']?.Ramya ?? 0,                                    Sandeep: metrics?.statuses?.['Busy']?.Sandeep ?? 0,                                Kishore: metrics?.statuses?.['Busy']?.Kishore ?? 0,                                gradient: 'from-yellow-500 to-orange-600' },
    { title: 'Store Visit Day After Tomorrow',  total: metrics?.statuses?.['Store Visit Day after Tomorrow']?.total ?? 0,            Ramya: metrics?.statuses?.['Store Visit Day after Tomorrow']?.Ramya ?? 0,          Sandeep: metrics?.statuses?.['Store Visit Day after Tomorrow']?.Sandeep ?? 0,      Kishore: metrics?.statuses?.['Store Visit Day after Tomorrow']?.Kishore ?? 0,      gradient: 'from-lime-500 to-green-700' },
    { title: 'Asking for Rent',                 total: metrics?.statuses?.['Asking for rent']?.total ?? 0,                          Ramya: metrics?.statuses?.['Asking for rent']?.Ramya ?? 0,                         Sandeep: metrics?.statuses?.['Asking for rent']?.Sandeep ?? 0,                     Kishore: metrics?.statuses?.['Asking for rent']?.Kishore ?? 0,                     gradient: 'from-amber-500 to-yellow-700' },
    { title: 'Purchased',                       total: metrics?.statuses?.['Purchased']?.total ?? 0,                                Ramya: metrics?.statuses?.['Purchased']?.Ramya ?? 0,                               Sandeep: metrics?.statuses?.['Purchased']?.Sandeep ?? 0,                           Kishore: metrics?.statuses?.['Purchased']?.Kishore ?? 0,                           gradient: 'from-green-400 to-emerald-700' },
    { title: 'Switch Off',                      total: metrics?.statuses?.['Switch off']?.total ?? 0,                               Ramya: metrics?.statuses?.['Switch off']?.Ramya ?? 0,                              Sandeep: metrics?.statuses?.['Switch off']?.Sandeep ?? 0,                          Kishore: metrics?.statuses?.['Switch off']?.Kishore ?? 0,                          gradient: 'from-slate-600 to-gray-800' },
  ];
