...
import { Mail, Phone, MapPin, ShieldCheck, FileText, RotateCcw, PackageSearch, Truck, Instagram, Youtube } from 'lucide-react';
import { storeInfo } from '@/data/store-info';

const MAPS_URL =
  'https://www.google.com/maps/place/Satya+Computers/@17.4381008,78.4449618,17z/data=!4m14!1m7!3m6!1s0x4f64ae8bda9f24bd:0xa4712061712e6176!2sSatya+Computers!8m2!3d17.4381008!4d78.4449618!16s%2Fg%2F11y2bprzd0!3m5!1s0x4f64ae8bda9f24bd:0xa4712061712e6176!8m2!3d17.4381008!4d78.4449618!16s%2Fg%2F11y2bprzd0?entry=ttu&g_ep=EgoyMDI2MDMxOC4xIKXMDSoASAFQAw%3D%3D';
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex flex-col gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 border border-[#25D366]/40 text-[#25D366] text-sm font-heading tracking-widest hover:bg-[#25D366] hover:text-black transition-all duration-300 w-fit"
              >
              ...
              <div className="flex gap-3">
                <a
                  href="https://www.instagram.com/satyacomputers23/"
                  target="_blank"
                  rel="noopener noreferrer"
                  title="Follow Satya Computers on Instagram"
                  className="w-10 h-10 border border-white/10 flex items-center justify-center text-white/50 hover:bg-[#E4405F] hover:text-white hover:border-transparent transition-all duration-300"
                >
                  <Instagram size={18} />
                </a>
                <a
                  href="https://www.youtube.com/@satyacomputers01"
                  target="_blank"
                  rel="noopener noreferrer"
                  title="Subscribe to Satya Computers on YouTube"
                  className="w-10 h-10 border border-white/10 flex items-center justify-center text-white/50 hover:bg-[#FF0000] hover:text-white hover:border-transparent transition-all duration-300"
                >
                  <Youtube size={18} />
                </a>
              </div>
